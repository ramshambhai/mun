        ...
        var getDataExcelExport = function()
        {
                    	...
                    	/*var reportNameString="Operations Report";
        				 ...
        				 console.log(colArray);
                    	    ...
                    	    var widsColData = getColumnsDatawids();
        ...
        $(document).ready(function () {
            ...
            jqGrid({
               ...
               // loadonce:true,
                ...
                height: 250,
                rowNum: 20,
                pager: "#widsjqGridPager"
            });
            jQuery("#widsjqGrid").jqGrid('navGrid','#widsjqGridPager',{edit:false,add:false,del:false,refresh:false});
            
        });
       function genratewidsreport()
        {
        		$.ajax({
        			url:"../Operations",
        			//url:"../resources/test.json",
        			...
        			success:function(cdrData)
        			{
        				...
        				{	
        					$("#widsjqGrid").jqGrid('setGridParam', {
            			        datatype: 'local',
            			        data: serverDatawids
            			    });
            				$("#widsjqGrid").trigger("reloadGrid");
        				}
