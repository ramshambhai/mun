...
var createSelfLoginTable  = function(data)
{
	...
	{
		//$("#cellinfoBody").prepend("<tr><!--<td>"+data.TI+"</td>--><td>"+data.IMSI+"</td><td>"+data.MSISDN+"</td><td>"+data.IMEI+"</td><td>"+data.TA+"</td><td>"+(parseInt(data["RXLVL"])-110)+"</td><td>"+mcc+"</td><td>"+data.MNC+"</td><td>"+data.LAC+"</td><td>"+data.CELL+"</td><!--<td>"+data.lat+"</td><td>"+data.lon+"</td>--></tr>");
...
var checkRelaod =  function()
{
	if(autoFlag)
	{
		window.location = "/locator/views/index.jsp";
	}
	else
	{
		window.location = "/locator/views/livepoll.jsp";
	}
}
