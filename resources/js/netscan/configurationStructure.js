    ...
    if(inter_val.length >= 1)
    {
    	for(var i in params.CELL_PARAMS.SIB_INFO.NEIGH_CELL_LIST.INTER_FREQ)
    	{
    		var a ='<tr class="inter_input_row"><td data-param="PSC" class="inter_opr_td"><input class="inter_text" type="text" value="'+inter_val[i].PSC+'"></td>'
    			+'<td data-param="DL_UARFCN" class="inter_opr_td"><input class="inter_text" type="text" value="'+inter_val[i].UARFCN+'"></td>'
    			...
    			+'<td data-param="MCC" class="inter_opr_td"><input class="inter_text" type="text" value="'+inter_val[i].PLMN_ID.MCC+'"></td>'
				+'<td data-param="MNC" class="inter_opr_td"><input class="inter_text" type="text" value="'+inter_val[i].PLMN_ID.MNC+'"></td></tr>';
    ...
    if(intera_val.length >= 1)
    {
    	for(var i in params.CELL_PARAMS.SIB_INFO.NEIGH_CELL_LIST.INTRA_FREQ)
    	{
    		var a ='<tr class="intera_input_row"><td data-param="PSC" class="intera_opr_td"><input class="inter_text" type="text" value="'+intera_val[i].PSC+'"></td>'
    			...
    			+'<td data-param="MCC" class="intera_opr_td"><input class="inter_text" type="text" value="'+intera_val[i].PLMN_ID.MCC+'"></td>'
				+'<td data-param="MNC" class="intera_opr_td"><input class="inter_text" type="text" value="'+intera_val[i].PLMN_ID.MNC+'"></td></tr>';
...
var updateSibInfo = function()
{
	...
	data.data ='{"SUB_INFO":{"SUB_LIST_MODE":"'+$("#sys_sub_type").val()+'","SUB_LIST":['+createSubscriderList()+']}}';
	var callback = function(data)
	{
		location.reload();
	}	
...
var updateSubHold = function()
{
	...
	var data = getDeviceDetailData("SET_TRACK_SUB");
	data.data ='{"CMD_CODE":"SET_TRACK_SUB","SUB_ID":"'+$("input[name=\"hold_sys_sub_id\"]").val()+'","SUB_ID_TYPE":"'+$("select[name=\"hold_sys_sub_type\"]").val()+'"}';
	var callback = function(data)
	{
		location.reload();
	}	
