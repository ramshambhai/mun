        ...
        $(document).ready(function () {
            ...
            jqGrid({
                ...
                [
                    ...
                    { label: 'origin', name: 'origen', width: 150,search: true },
                    { label: 'Scanner ID', name: 'nsid', width: 150,search: true },
        ...
        var registerEvents = function()
        {
        	...
        	$("#get_cdr_data").click(function(){
        		...
        		$.ajax({
        			url:dirPath+"service/netscan/alarms",
        ...
        var collnames={};
        	    ...
        	    collnames['origin']='origen';
        	    collnames['sufi_id']='nid';
