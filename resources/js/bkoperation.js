...
deviceData={"deviceIp":deviceIp,"hwCapabilityTypeId":hwCapabilityTypeId,"useTypeId":useTypeId,"paPower":device_pa_power,"paGain":device_pa_gain};
	$.ajax
	({
...
var add3gDevice = function()
{
	...
	data={"groupName":groupName,"useTypeId":useTypeId,"ofIp":ofIp,"ppfIp":ppfIp,"spfIp":spfIp,"hwCapabilityTypeIdOf":hwCapabilityTypeIdOf,"hwCapabilityTypeIdPpf":hwCapabilityTypeIdPpf,"hwCapabilityTypeIdSpf":hwCapabilityTypeIdSpf,"paGain":$("#3g_device_pa_gain").val(),"paPower":$("#3g_device_pa_power").val()};
	$.ajax({
...
var add4gDevice = function()
{
	...
	data={"groupName":groupName,"useTypeId":useTypeId,"ofIp":ofIp,"ppfIp":ppfIp,"spfIp":spfIp,"hwCapabilityTypeIdOf":hwCapabilityTypeIdOf,"hwCapabilityTypeIdPpf":hwCapabilityTypeIdPpf,"hwCapabilityTypeIdSpf":hwCapabilityTypeIdSpf,"paGain":$("#4g_device_pa_gain").val(),"paPower":$("#4g_device_pa_power").val()};
	$.ajax({
	...
	$.ajax({
        ...
        type:"post",
	        ...
	        success:function(data)
	        {
	        	...
	        	for (i = 0; i < 4; i++) {
	        		substart.push((configData[i].freqStart/1000).toFixed(0));
	        		subend.push((configData[i].freqEnd/1000).toFixed(0));
...
//	inputToSend+=sub9start+"-"+sub9end+ " ";
	...
	$.ajax({
	    ...
	    data:{"data":inputToSend,ip"txPower":txPower ,"loIfOffsetKhz":loIfOffsetKhz, "appliedFrequency" : appliedFrequency},
        type:"post",
        success:function(data)
        {
        	if(data==1){
