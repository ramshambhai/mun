...
<link href="../../resources/css/tool/map.css" rel="stylesheet">
...
<div id="data-panel">
	...
	<ul class="nav nav-tabs">
		...
		<li class="nav-item "><a class="nav-link " data-toggle="tab" id="his_opr_tab" href="#his_opr">Captured Mobiles</a></li>
	
	</ul>
	<div class="tab-content" id="live_his_tab">
		<div id="live_opr" class="tab-pane fade in ">
			
			<div style="width:100px;overflow:auto;">
				<table id="oprgrid"></table>
			</div>
			<div id="oprGridReportPager" style="text-align: center;"></div>
		</div>
...
$(document).ready(function(){
	   ...
	   //Below lines is used to click on Captured Mobile information to show the Jqgrid
	   
	   document.getElementById("his_opr_tab").click();
    });
	

</script>
   </div>
		<div id="his_opr" class="tab-pane fade in active">
			<div id="opr_filter_div">
			
				<table id="opr_filter"> 
					<tr>
						<td><button id="clear_checks" onclick="clearMapOprTower()">Clear Map</button></td>
						<td></td>
						<td>Date(yyyy-mm-dd)</td>
						<td>
					
				 			<input id="start_date"  class="dateSelect" placeholder="Start date"  type="text"/>
			 			</td>
						<td>
							<input id="end_date"  class="dateSelect" placeholder="End date"  type="text"/>
						</td>
						
						
						<td><button id="gen_report">Get</button></td>
					</tr>
				</table>
			</div>
			<table id="his_oprgrid" ></table>
			<div id="his_oprGridReportPager" style="text-align: center;"></div>
		</div>
		<!-- <table id="oprgrid"></table>
			<div id="oprGridReportPager" style="text-align: center;"></div>-->
	</div>
...
<div class="modal fade" id="detected_mobile_modal" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content" style="overflow:auto">
				...
				<div class="modal-body">
				<div id="detected_mobile_modal_body" style="overflow:auto;"></div>
...
/***********************************************************/
	...
	function onMapClick(e) {
		...
		alert("Latitude, Longitude : " + parseFloat(e.latlng.lat).toFixed(5) + ", " + parseFloat(e.latlng.lng).toFixed(5));
	//	alert("Location : " + parseFloat(e.latlng.lat).toFixed(5));
	...
	/* 
	    ...
	    map.panTo(new L.LatLng(3, 4));
	    
	    L.circle([28.7041, 77.1025], {radius: i,color:"black",opacity:1,fillColor:"#fff59f",fillOpacity:0.1})
	    clickCircle = L.circle([3,4], 1609 * 3, {
	    ...
	    alert(e.latlng);
	    clickCircle2 = L.circle([3,4], 1800 * 3, {
	      color: '#f07300',
	      fillOpacity: 0,
	      opacity: 0.5
	    }).addTo(map); */
...
function loadLeafMap()
{
 ...
 map = new L.Map('map_leaf', {center: new L.LatLng(28.7041, 77.1025),  zoom:15});
...
//});
	...
	for ( var p = 0; p < grid[0].rows.length -1 ; p++) {
	      ...
	      //var rowData = jQuery(this).getRowData(p);  
	      console.log(rowData);
...
var addOprTower2 = function(position,url,ddd,distance,name1)
{
	try
	{	
		   if (test != undefined) {
...
var removeOprTower2 = function(name1)
{
	try
	{
		   var theName=name1;
...
var displayDetectedMobiles = function(data){
			...
			for(var i in data)
			{
			   ...
			   var image="user2.png";
			   var backgroundColor="rgb(198,227,159)";
			   
			   if(data[i].mobile_type == "0")
			   {
				   name="UNMAPPED";
				   image="user1.png";
				   backgroundColor="rgb(251, 201, 142)";
			   }			   
...
$('#toggle_device_tab').click(function () {
  ...
  function startTime() {
    ...
    <script src="../../resources/js/tool/imsiUpdate.js" type="text/javascript"></script>
	<script src="../../resources/js/tool/maps.js" type="text/javascript"></script>
	<script src="../../resources/js/tool/scanner.js" type="text/javascript"></script>
