...
<jsp:include page='header.jsp' />
 <script type="text/javascript" src="../resources/js/index3.js"></script>
	...
	<div id="message_box">
		...
		<fieldset id="target_scan">
			...
			<table>
				<tr>
					<td>IMSI</td>
					<td><input type="text" value="123456789098765" id="imsi_number" max-lenght=15 name="imsi_number"></td>
					<td>Latitude</td>
					<td><input type="text" value="1.1" id="lat" max-lenght=15 name="lat"></td>
					<td>Longitude</td>
					<td><input type="text" value="1.1" id="lon" max-lenght=15 name="lon"></td>
					<td>Select Cells</td>
		...
		<div id="bottomdiv" style="display:block;">
			...
			<div id="map_div" style="width:62%"></div>
		</div>			
	</div>
