...
<table style="float:left">
	<tr>		
		...
		<td class="dropdown" style="margin-top:14px;width: 100px;"><a class="dropbtn" href="GroupConfiguration.jsp">Configuration</a></td>
		<td>>></td>
		<td class="dropdown" style="margin-top:14px;width: 100px;"><a class="dropbtn" href="SubiOpr.jsp">Operations</a></td>
