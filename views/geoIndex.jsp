...
<div id="container">
	<div id="message_box" style="background: rgba(255, 255, 255, 0.5) url('../resources/images/back_map.jpg');background-size: cover;">
		<div id="topdiv" style="width:100%;height:100%;display:table;">
			<div id="req_box" style="width:500px;height:500px;margin:250px auto;display: table-cell;vertical-align: middle;">
								<table id="req_tab" style="margin:0 auto;">
									<td style="text-align: center;">Track Subscriber</td>
									<tr>
										<td>
									...
									<tr>
										<td>
											...
											<input type="text" id="schedulerPeriodicity" class="input_type" name="periodicity" style="width: 220px;"/>
										</td>
									</tr>
									<tr>
				...
				<tr>
					...
					<td>
						...
						<table>
							...
							<tr><td>Home Country /MCC</td><td><input type="text" name="res_HMCC" id="res_HMCC" readonly/></td></tr>
							<tr><td>Home Operator /MNC</td><td><input type="text" name="res_HMNC" id="res_HMNC" readonly/></td></tr>
							<tr><td>Host Country /MCC</td><td><input type="text" name="res_HOMCC" id="res_HOMCC" readonly/></td></tr>
							...
							<tr><td>MSC address</td><td><input type="text" name="res_msc" id="res_msc" /></td></tr>
							<tr><td>FTN</td><td><input type="text" name="res_ftn" id="res_ftn" /></td></tr>
							<tr><td></td><td></td></tr>
							<tr><td id="opr_buttons" colspan=2><button style="margin:0 auto;" class="btn-match" id="block_service">BLOCK SERVICES</button>&nbsp;<button class="btn-match" style="margin:0 auto;" id="diveret_service">CALL DIVERT</button>&nbsp;<button class="btn-match" style="margin:0 auto;" id="trace_intercept">CALL INTERCEPT</button>&nbsp;<button class="btn-match" style="margin:0 auto;" id="sms_intercept">SMS INTERCEPT</button></td></tr>
							<tr><td id="opr_buttons_2" colspan=2><button class="btn-match" style="margin:0 auto;" id="stop_sms_intercept">STOP SMS INTERCEPT</button><!--  &nbsp;<button class="btn-match" style="margin:0 auto;" id="stop_call_intercept">STOP CALL INTERCEPT</button>-->&nbsp;<button class="btn-match" style="margin:0 auto;" id="stop_call_divert">STOP CALL DIVERT</button></td></tr>
						</table>					
					</td>
	...
	<div style="display:none;margin:0 auto;position:absolute;width:100%;height:100%;">
		<img style="display:table-cell;vertical-align:middle;" src="../resources/images/loading_bar_animated.gif">
	</div>	
</div> 
	...
	<link rel="stylesheet" href="../resources/css/ol.css" />
 	...
 	<script type="text/javascript" src="../resources/js/geoIndex.js"></script>
 	<style>
 		#container
 		{
 			height:93%;
